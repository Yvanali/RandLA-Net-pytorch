...
grid_size = 0.06
dataset_path = '/media/omnisky/dataset_disk/xuyan/SemanticKITTI/dataset/sequences'
output_path = '/media/omnisky/dataset_disk/xuyan/SemanticKITTI/dataset/sequences' + '_' + str(grid_size)
